...
class MobileNetV3(nn.Module):
    def __init__(
        ...
        for (in_channels, kernel_size, expansion_size, out_channels, squeeze_exitation, activation, stride,) in configs_dict[config]:
            self.model.append(
...
if __name__ == "__main__":
    ...
    print(model(torch.rand((1, 3, 640, 320)))[-1].shape)
