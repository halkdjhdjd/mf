...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # ----------------------------------------------------------
                   ...
                   FocalModulation, ScConv,
                   }:
            c1 = ch[f]
            c2 = ch[f]
            args = [c1, *args]

        elif m in {AIFI, CARAFE, DySample, HWD, HWD_ADown, SPDConv, SPD_ADown, Conformer, GhostConformer}:
            c1 = ch[f]
            c2 = ch[f]
            args = [c1, *args]
            ...
            args = [c1]
                   ...
                   RepNCSPELAN4iRMB, Rep_SC_Atten, C2f_LSK, C3_LSK, RepNCSPELAN4_CD_LSK, C3_CD_LSK, C2f_CD_LSK}:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
                   ...
                   GhostInceptionV2c, GhostInceptionV2a, GhostInceptionV2b, DepthwiseSepConvBlock
                   }:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
